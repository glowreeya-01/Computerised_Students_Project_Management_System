                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-sm-6">
                                <div class="form-group">
                                    <label>File</label>
                                    <input type="checkbox" name="" id="checkFile">
                                    <input type="file" name="file" id="fileInput" style="display: none;" class="form-control @error('file') is-invalid @enderror" >
                                    <select id="fileInputTXT" class="form-control @error('file') is-invalid @enderror" name="" placeholder="file">
                                        <option class="dropdown-item " value="{{ $project->file }}">{{ $project->file }}</option>
...
<script>
    ...
    $('#checkFile').on('click' ,function () {
        ...
        if (checkFile.is(':checked') ) {
            ...
            // $('#fileInputTXT').removeAttr('value');
            // $('#fileInputTXT').attr('type', 'file');
            $('#fileInput').show();
            $('#fileInputTXT').hide();
            ...
            $('#fileInputTXT').show();
            $('#fileInput').hide();
            // $('#fileInputTXT').attr('disabled', 'disabled');
            // $('#fileInputTXT').attr('type', 'text');
