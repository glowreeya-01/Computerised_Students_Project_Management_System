                                ...
                                <tr>
                                    ...
                                    <td class="text-right">
                                        <div class="actions">
                                            ...
                                            <a href="{{ route('project.edit', $project->id) }}" class="btn btn-sm bg-success-light mr-2">
                                                <i class="fas fa-pen"></i>
                                            </a>
                                            

                                            <button id="deleteBtn" type=""  data-attr="{{ route('project.delete', $project->id) }}" class="btn btn-sm bg-danger"><i class="fas fa-trash"></i></button>
