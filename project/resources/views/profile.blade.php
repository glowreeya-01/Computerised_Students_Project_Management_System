            ...
            <div class="profile-header">
                <div class="row align-items-center">
                    <div class="col-auto profile-image">
                        <a href="#">
                            <img class="rounded-circle" alt="User Image" height="200px" width="200px" src="{{ $profileImage }}">
                        </a>
                    </div>
                    <div class="col ml-md-n2 profile-user-info">
                        <h4 class="user-name mb-0">{{ $user->firstname }} {{ $user->lastname }}</h4>
                        <h6 class="text-muted">
                            {{-- {{ ($user->role == 1)? 'Student' : 'Teacher' }} --}}
                            @if ($user->role == 1)
                            Student
                            @elseif ($user->role == 2)
                            Teacher
                    ...
                    <div class="col-auto profile-btn">
                        ...
                        @if ($user->role == 1)
                        <a href="{{ route('student.edit') }}" class="btn btn-primary">
                            Edit
                        </a>
                        @elseif ($user->role == 2)
                        <a href="{{ route('teacher.edit') }}" class="btn btn-primary">
                            Edit
                        </a>
                        @else
