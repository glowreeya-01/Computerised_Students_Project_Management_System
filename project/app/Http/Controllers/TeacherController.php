...
class TeacherController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('teacher.create', compact('user','profileImage','notifications'));
    }
    ...
    public function show()
    {
        ...
        return view('teacher.show', compact('user','profileImage','notifications'));
    }
    ...
    public function edit()
    {
        ...
        return view('teacher.edit', compact('user','profileImage','notifications'));
    }
